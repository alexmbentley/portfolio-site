...
const ProjectItem = ({ title, backgroundImg, projectUrl, techStack }) => {
  return (
    <div className="relative flex items-center  justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r hover:duration-150 from-[#a245ff] to-[#7b00f6] ">
      <Image
